...
The benchmark includes random validation and grouped/out-of-component validation where possible. Grouped and held-out-component splits carry the main generalization interpretation.
...
Uncertainty is evaluated against actual errors and low-confidence predictions are flagged for review.

## 9. Active-Learning Simulation

The active-learning simulation is a budgeted selection workflow over existing public records. It uses multiple seeds, includes a random baseline, and compares Random selection, Highest predicted yield, Uncertainty sampling, Diversity-aware, Score plus uncertainty, and Diverse high-score strategies.
...
- The current feature set is categorical and component-label based.
...
- Existing-record ranking is decision-support analysis over public records.
...
The fixture tests code paths; benchmark metrics come from committed public-data reports.
