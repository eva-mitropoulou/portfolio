...
def build_final_report() -> dict[str, Any]:
    ...
    final_summary = {
        ...
        "safe_scope": [
            ...
            "component-label public HTE benchmark",
...
Reaction Yield Prediction from Public HTE Component Labels is a retrospective public-data benchmark for reaction-yield modeling.
...
The active-learning simulation is a budgeted selection workflow over existing public records. It uses multiple seeds, includes a random baseline, and compares {', '.join(active_strategy_labels)}. It ranks existing public records within each simulated budget.
