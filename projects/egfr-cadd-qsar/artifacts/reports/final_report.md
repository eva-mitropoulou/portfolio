...
The performance drop under scaffold split is the central result because it demonstrates leakage-aware validation. The model is presented as a retrospective baseline benchmark with scaffold-aware validation.

## Limitations

- Baseline retrospective QSAR.
- Retrospective baseline benchmark with scaffold-aware validation.
