...
Benchmarking and existing-record prioritization for public antibody sequence records, with grouped validation, source-holdout analysis, calibration checks, unsupervised sequence-landscape analysis, and OAS background retrieval.
...
- Unsupervised landscape: 5,573 rows, cached pair embeddings, KMeans, 9 clusters, labels overlaid after clustering.
...
- Unsupervised clustering uses sequence-derived features only; labels are used afterward for enrichment summaries.
