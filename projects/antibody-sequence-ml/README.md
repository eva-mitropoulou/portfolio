...
<p align="center">
  <img src="artifacts/docs/assets/project_workflow.png" alt="Project workflow from public antibody rows to model validation and review outputs" width="100%">
</p>
...
<p align="center">
  <img src="artifacts/docs/assets/broad_model_benchmark.png" alt="Broad model benchmark on the full strict labelled dataset" width="100%">
</p>
...
<p align="center">
  <img src="artifacts/docs/assets/kmer_vs_igbert_followup.png" alt="K-mer and IgBERT follow-up model comparison" width="100%">
</p>
...
<p align="center">
  <img src="artifacts/docs/assets/selected_model_robustness.png" alt="Selected model robustness and threshold 0.7 review cutoff" width="100%">
</p>
...
This is a retrospective public-record workflow. It does not design antibodies, generate new sequences, mutate sequences, optimize therapeutics, or claim experimental validation. Scores are used as prioritization signals for existing records that may deserve closer expert review.

## Reproduce

The full source repository includes generated reports and machine-readable metrics. Some raw and processed sequence tables are local artifacts and may not be committed.

Full repository:

```text
https://github.com/eva-mitropoulou/antibody-prioritization
```

Cached portfolio checks:
...
- `artifacts/reports/oas_existing_record_shortlist_report.md`
- `artifacts/docs/DATA_CARD.md`
- `artifacts/docs/MODEL_CARD.md`
- `artifacts/Makefile`

Machine-readable summaries are under `artifacts/reports/metrics/`.
