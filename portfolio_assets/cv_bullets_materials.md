# CV Bullets: Materials and Molecular Simulation

## Recommended Safe Bullets

| Bullet text | Supporting repository/report | Metric source | Risk level |
|---|---|---|---|
| Analyzed polypropylene and brucite molecular dynamics interfaces using aggregate contact-count and interaction-energy summaries for coated versus uncoated filler surfaces. | `polymer-md/reports/final_report.md` | `polymer-md/reports/metrics/summary.json` | safe |
...
| Developed ORCA and CREST plus periodic Quantum ESPRESSO project assets for flame-retardant and inorganic materials modeling. | `flame-retardants/README.md`, `periodic-dft/README.md` | Artifact inventory in `portfolio_audit/evidence_map.json` | safe |
