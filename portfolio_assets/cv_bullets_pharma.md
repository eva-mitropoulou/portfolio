...
| Developed a public-data antibody sequence ML benchmark with grouped validation, k-mer TF-IDF baselines, CDR-local feature comparisons, and antibody representation benchmark artifacts. | `antibody-sequence-ml/reports/final_report.md` | `antibody-sequence-ml/reports/metrics/summary.json` | safe |
