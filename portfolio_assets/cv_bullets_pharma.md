...
| Demonstrated validation-risk awareness by comparing Morgan random forest performance under random split and scaffold split, with RMSE and R2 changing from 0.712 and 0.719 to 0.871 and 0.550. | `projects/egfr-qsar-cadd.md` | `egfr-cadd-qsar-admet/reports/metrics/summary.json` | safe |
