...
|---|---|---|---|
| Built a retrospective EGFR CADD and QSAR decision workflow from ChEMBL, curating 26,600 IC50 records into 10,593 model-ready molecules; benchmarked RDKit descriptor, Morgan fingerprint, and GPU PyTorch GCN models under random and scaffold splits, with Morgan RF achieving scaffold-split RMSE 0.871 and R2 0.550; quantified applicability-domain degradation from high-similarity MAE 0.513 to low-similarity MAE 0.957; added assay-aware validation, split-conformal uncertainty, ADMET-style and model-risk triage, SAR and error analysis, active-learning simulation, CLI prediction, ligand-contact analysis across four EGFR PDB structures, and 5UG9 redocking validation recovering the 8AM co-crystal pose at 0.968 A RMSD. | `egfr-cadd-qsar-admet/reports/final_egfr_cadd_qsar_report.md` | `egfr-cadd-qsar-admet/reports/metrics/egfr_final_hardening_status.json` | safe |
